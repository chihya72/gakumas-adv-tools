...
| 🟡 | **BgmStop** | 中 | 极低 | 中 | 4 |
| 🟡 | **Se** | 中 | 极低 | 中 | 5 |
| 🟢 | **ActorEyeBlink** | 低 | 极低 | 低 | 7 |
| 🟢 | **ActorLookTarget** | 低 | 低 | 低 | 8 |
| 🟢 | **ActorAdditiveMotion** | 低 | 低 | 低 | 9 |
| 🟢 | **Dof** | 低 | 低 | 低 | 10 |
| 🟢 | **ColorEffect** | 低 | 低 | 低 | 11 |
| 🟢 | **ActorLookTargetTween** | 低 | 低 | 低 | 12 |
| 🟢 | **ActorLighting** | 低 | 中 | 低 | 13 |
| 🟢 | **Timeline** | 低 | 极低 | 低 | 14 |
...
2. **BgmStop** - 仅 1 个数字字段
3. **Se** - 仅 2 个字段
4. **ActorEyeBlink** - 仅 2 个字段
5. **Dof** - 仅 3 个数字字段
6. **ColorEffect** - 仅 2 个字段
7. **Timeline** - 仅 1 个文本字段

**预计减少：** 约 7 个命令使用 GenericEditor → 专用编辑器
